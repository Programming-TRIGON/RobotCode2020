...
public class RobotA extends RobotConstants {
    ...
    public RobotA() {
        ...
        intakeConstants.kStallTimeout = 0.5;
        ...
        intakeOpenerConstants.kOpenAngle = 118.652344;
        ...
        climbConstants.kHookPotentiometerOffset = -3.54;
        climbConstants.kPotentiometerChangeError = 0.2;
        ...
        controlConstants.visionDistanceSettings = new PIDSettings(0, 0, 0, 15, 15);
